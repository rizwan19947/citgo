...
function SectionHeading({ children }: { children: React.ReactNode }) {
	return (
		<div className="flex items-center gap-4 my-12">
			<div className="flex-1 h-[2px] bg-[#ae222f]" />
	...
	return (
		<div className="relative w-full min-h-[400px] md:min-h-[500px] flex items-center">
			{bgImage ? (
				...
				<div className="absolute inset-0 bg-[#ae222f]" />
			)}
			...
			<div className="relative z-10 max-w-7xl mx-8 md:mx-32 lg:mx-72 px-6 md:px-12 py-12 md:py-16">
				...
				<Link
					...
					className="inline-block shadow-lg border-2 border-white text-white font-bold text-shadow-lg text-sm uppercase tracking-widest px-6 py-3 hover:bg-white hover:text-[#ae222f] transition-colors"
				>
					Read Article
				</Link>
			</div>
	...
	return (
		<div className="flex flex-col bg-white shadow-md rounded overflow-hidden">
			...
			<div className="p-5 flex flex-col flex-1">
				<p className="text-xs font-bold text-[#ae222f] uppercase tracking-wide mb-1">
					{issueTitle}
				</p>
				...
				<Link
					href={`/${article.issueSlug}/${article.slug}`}
					className="text-sm font-bold text-[#ae222f] uppercase hover:underline"
				>
					Read More &rsaquo;
				</Link>
			</div>
